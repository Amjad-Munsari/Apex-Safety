...
//
// Requires a VALID SUPABASE_SERVICE_ROLE_KEY in .env.local. Run:
//   node scripts/ensure-client-test-user.mjs
...
const TEST_PASSWORD = process.env.TEST_CLIENT_PASSWORD || 'test123'
