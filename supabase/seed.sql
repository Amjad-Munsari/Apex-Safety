-- seed.sql
-- Apex Safety OS Platform — Dummy Data Seed
...
VALUES 
  ('a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d', 'Grand Horizon Hotel Ltd', '12 Grand Avenue, London', 14, TRUE),
...
VALUES
  ('3497bbaa-f5c9-4d3b-a9d2-b13795d60e83', 'Alex Taylor', 'admin@test.com')
...
-- Auth account: user@test.com — linked to Grand Horizon Hotel Ltd.

INSERT INTO client_users (id, client_id, name, email, role)
VALUES
  ('89ceb1b3-72fc-4c99-925e-266fbf3e1238', 'a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d', 'Apex Client Admin', 'user@test.com', 'admin')
ON CONFLICT (id) DO NOTHING;
