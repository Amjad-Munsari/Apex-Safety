...
export default function AuthCodeErrorPage() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 px-4">
      <div className="relative z-10 w-full max-w-md text-center text-white space-y-4">
        ...
        <Link
          href="/auth/login"
          className="inline-block bg-red-600 hover:bg-red-700 text-white font-semibold rounded-md px-6 py-3 transition-colors"
        >
          Go to sign in
        </Link>
      </div>
