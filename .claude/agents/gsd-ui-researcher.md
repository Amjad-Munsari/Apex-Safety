...
Use template from `C:/dev/Antigravity/888 Safety/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/dev/Antigravity/888 Safety/.claude/get-shit-done/templates/UI-SPEC.md`
