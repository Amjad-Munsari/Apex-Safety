...
<required_reading>
@C:/dev/Antigravity/888 Safety/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/dev/Antigravity/888 Safety/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/dev/Antigravity/888 Safety/.claude
                  → checks C:/dev/Antigravity/888 Safety/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/dev/Antigravity/888 Safety/.claude/get-shit-done
                  → writes to C:/dev/Antigravity/888 Safety/.claude/get-shit-done/hooks/
...
@C:/dev/Antigravity/888 Safety/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/dev/Antigravity/888 Safety/.claude/get-shit-done/references/common-bug-patterns.md
