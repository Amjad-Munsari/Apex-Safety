...
Reference full template: `C:/dev/Antigravity/888 Safety/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/dev/Antigravity/888 Safety/.claude/get-shit-done/templates/state.md`.
