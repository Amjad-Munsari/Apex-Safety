...
```bash
INIT=$(node "C:/dev/Antigravity/888 Safety/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/dev/Antigravity/888 Safety/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
