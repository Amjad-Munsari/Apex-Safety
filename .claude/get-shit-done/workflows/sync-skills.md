...
INSTALL_JS_GLOBAL="C:/dev/Antigravity/888 Safety/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/dev/Antigravity/888 Safety/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
