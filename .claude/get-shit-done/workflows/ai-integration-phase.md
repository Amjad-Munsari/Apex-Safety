...
<required_reading>
@C:/dev/Antigravity/888 Safety/.claude/get-shit-done/references/ai-frameworks.md
@C:/dev/Antigravity/888 Safety/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/dev/Antigravity/888 Safety/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/dev/Antigravity/888 Safety/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/dev/Antigravity/888 Safety/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/dev/Antigravity/888 Safety/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/dev/Antigravity/888 Safety/.claude/agents/gsd-eval-planner.md for instructions.
