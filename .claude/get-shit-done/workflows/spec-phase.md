...
```bash
INIT=$(node "C:/dev/Antigravity/888 Safety/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/dev/Antigravity/888 Safety/.claude/get-shit-done/templates/spec.md.
