...
```markdown
Read C:/dev/Antigravity/888 Safety/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/dev/Antigravity/888 Safety/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/dev/Antigravity/888 Safety/.claude/agents/gsd-ui-checker.md for instructions.
