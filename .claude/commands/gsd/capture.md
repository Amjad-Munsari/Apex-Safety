...
<execution_context>
@C:/dev/Antigravity/888 Safety/.claude/get-shit-done/workflows/add-todo.md
@C:/dev/Antigravity/888 Safety/.claude/get-shit-done/workflows/note.md
@C:/dev/Antigravity/888 Safety/.claude/get-shit-done/workflows/add-backlog.md
@C:/dev/Antigravity/888 Safety/.claude/get-shit-done/workflows/plant-seed.md
@C:/dev/Antigravity/888 Safety/.claude/get-shit-done/workflows/check-todos.md
