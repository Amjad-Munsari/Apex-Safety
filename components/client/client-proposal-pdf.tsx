              ...
              <div key={item.id} className="grid grid-cols-[1fr_auto] gap-6 py-3 border-b border-[#1a1a1a]/10">
                <div>
                  <div className="font-sans text-[12.5px] text-[#1a1a1a] flex items-center gap-3">
                    <span className="font-mono text-[10px] text-[#8a857f] w-6">{String(i + 1).padStart(2, "0")}</span>
                    {item.name}
                  </div>
                  <div className="font-sans text-[11px] text-[#8a857f] ml-9 mt-1">{item.detail}</div>
                </div>
