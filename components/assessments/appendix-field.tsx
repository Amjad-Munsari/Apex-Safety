...
export function AppendixField({
  ...
  return (
    <div className="border-l-2 border-[var(--p-gold)]/40 pl-6 py-2 mt-8">
      <div className="mb-6">
        <h3 className="text-xl font-medium text-[var(--p-text)] tracking-wider">
          ADDITIONAL OBSERVATIONS
        </h3>
        <p className="text-[var(--p-text-muted)] text-sm mt-1">
